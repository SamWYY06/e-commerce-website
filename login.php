...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        mysqli_stmt_bind_result($stmt, $db_username, $db_role, $db_password);
...
<div class="page-container">
    ...
    <div class="login-container">
        ...
        <p>Log back in to continue enjoying your favourite treats and access exclusive bakery rewards!</p>
